...
// here the image is converted to base64 internally by Dropzone and made available in file.dataURL.
...
function init() {
    ...
    dz.on("complete", function (file) {
        ...
        var url = "/project2_api/classify_image"
        ...
        $.post(url, {
            ...
            */
            ...
            let players = ["ms_dhoni", "greta_thunberg", "mark_rufallo", "rihanna", "tom_hiddleston"];
